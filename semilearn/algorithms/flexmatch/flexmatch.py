...
class FlexMatch(AlgorithmBase):
    ...
    def get_save_dict(self):
        ...
        save_dict["selected_label"] = self.hooks_dict[
            "MaskingHook"
        ].selected_label.cpu()
        return save_dict
    ...
    def load_model(self, load_path):
        ...
        self.hooks_dict["MaskingHook"].classwise_acc = checkpoint["classwise_acc"].cuda(
            self.gpu
        )
        self.hooks_dict["MaskingHook"].selected_label = checkpoint[
            "selected_label"
        ].cuda(self.gpu)
